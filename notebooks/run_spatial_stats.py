...
Executable script for comprehensive spatial metrics generation
"""
...
def main(input_h5ad=None, output_dir=None):
    ...
    try:
        ...
        print("   ✓ Ripley's K complete")
    except Exception as e:
        print(f"   ✗ Ripley's K failed: {e}")
        ripley_stats = {}

    print("\n2. Running neighborhood enrichment...")
    try:
    ...
    print("\n4. Calculating nearest neighbor distances...")
    try:
    ...
    print("\n5. Running extended spatial autocorrelation...")
    try:
        ...
        print(f"   Testing {len(hvg_genes)} genes...")
        ...
        axes[0, 0].scatter(range(len(morans_df)), morans_df['I'], alpha=0.3)
        ...
        autocorr_stats = {
            ...
            'top_morans_i': [float(x) for x in top_spatially_variable['I'].head(10).tolist()]
        }
    ...
    print("\n6. Calculating cluster compactness...")
    try:
    ...
    print("\n7. Generating comprehensive metrics JSON...")
