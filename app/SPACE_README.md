...
- 🔬 **Automated cell type annotation** (5,181 markers, 163 cell types via PanglaoDB)
- 📊 **Spatial metrics** (Moran's I, spatial entropy, neighborhood enrichment)
- 🖼️ **Interactive visualizations** (cell type composition, spatial clusters)
- 📄 **Clinical pathology report** (generated by MedGemma with H&E image analysis)

**Key Features**:
- ✅ **Privacy-preserving**: Runs locally, no cloud APIs, HIPAA-compliant
- ✅ **Tissue-blind operation**: No data leakage (validated with adversarial tests)
- ✅ **Fast**: <2 minutes for 5,000 spots, <1 GB RAM
- ✅ **Open-source**: Full reproducibility, Docker deployment
...
2. **Configure Analysis**:
   - ☑️ Enable multimodal (H&E + text)
   - ☑️ Use marker-based annotation
   - 🎚️ Adjust Leiden resolution (0.1-2.0)
...
│  • Scanpy/Squidpy (QC, clustering)  │
│  • PanglaoDB markers (annotation)   │
...
│  • H&E image + text features        │
│  • SigLIP encoder (896×896)         │
└─────────────────────────────────────┘
    ↓
...
- ✅ 10/10 quality checks passed
- ✅ Anti-parroting validation (0 tissue leaks)
- ✅ Performance: 52.7 spots/second
- ✅ Memory efficient: <1 GB for 5K spots
...
- **Input**: H&E image (896×896) + spatial features
